...
function jump2(){
window.location.href="http://www.personalwebhhf.cn/Wecaht/Search_By_Fmale.php";
}
...
<?php	
	...
	$Score = mysql_query("SELECT Student_ID,Student_Name,Student_Time,Student_Score,Student_Headimgurl FROM Student_Data WHERE Student_Sex=0 ORDER BY Student_Score DESC");
	$Num = 1;
