...
//	echo $Nickname;
	...
	setcookie("nickname",$Nickname,time()+3600*2);
	setcookie("headimgurl",$pic,time()+3600*2);
	header("Location: http://www.personalwebhhf.cn/Wechat/Find_Others.php?openid=$Openid");
