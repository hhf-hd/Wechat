...
<div id="login_module">
   <form name="login_form" id="login_form" method="post" action="http://www.personalwebhhf.cn/PHP/Handle_Start_Game.php">
    <fieldset>
      <table>
		   ...
		   <select name="Time" class="S">
			...
			<option value="161129530">2016-11-29 5:30</option>
			<option value="161129600">2016-11-29 6:00</option>
			<option value="161129630">2016-11-29 6:30</option>
			<option value="161129700">2016-11-29 7:30</option>
			<option value="161129730">2016-11-29 7:30</option>
			<option value="161129800">2016-11-29 8:00</option>
			<option value="161129830">2016-11-29 8:30</option>
		...
		<tr>
		<input id ="name" type="hidden" name="openid" value=" <?php
	$Openid = $_GET['openid'];echo $Openid;?>"></input>
		</tr>
