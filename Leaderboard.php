...
<div id="img"  >
	...
	<div id="Male_Female">
	&nbsp;
	<button class="button blue" onclick=javascrtpt:jump1()>Male</button>
	<button class="button blue" onclick=javascrtpt:jump2()>Fmale</button>
	<button class="button blue" onclick=javascrtpt:jump3()>Search</button>
...
<?php	
	...
	$Score = mysql_query("SELECT Student_ID,Student_Name,Student_Time,Student_Score,Student_Headimgurl FROM Student_Data ORDER BY Student_Score DESC");
	$Num = 1;
